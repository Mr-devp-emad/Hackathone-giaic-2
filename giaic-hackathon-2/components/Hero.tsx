...
const Hero = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-6 max-w-[1200px] mx-auto px-4 sm:px-6">
    {/* Large Image (Left Column) */}
    <div className="lg:col-span-6 col-span-1 relative group">
      <img
    ...
    <div className="lg:col-span-3 col-span-1 relative group">
      <img
    ...
    <div className="lg:col-span-3 col-span-1 grid grid-rows-2 gap-6">
      {/* Top Small Image */}
